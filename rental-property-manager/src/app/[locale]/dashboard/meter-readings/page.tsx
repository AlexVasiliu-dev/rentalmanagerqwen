    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Urmărește și trimite citirile la contoare</p>
        </div>
      ...
      {session?.user.role === "RENTER" && (
        <Card>
          <CardHeader>
            <CardTitle>Trimite Citire la Contoare</CardTitle>
            <CardDescription>
              {t('photoRequired')}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className="text-sm font-medium mb-1 block">Tip Contor</label>
                  <select
                  ...
                  >
                    {meters.map((meter) => (
                      <option key={meter.id} value={meter.id}>
                        {getMeterTypeIcon(meter.type)} {getMeterTypeLabel(meter.type)}
                      </option>
                    ))}
                  </select>
                </div>
                <div>
                  <label className="text-sm font-medium mb-1 block">Tip Citire</label>
                  <select
                    ...
                    required
                  >
                    <option value="MONTHLY">Lunară</option>
